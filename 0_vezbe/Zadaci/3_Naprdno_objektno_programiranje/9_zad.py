"""Napraviti slušač za metodu dostignut_limitt. Potrebno je napraviti klasu Bankomat u kojoj se čuva stanje na kartici I fiksan limit kartice. 
Napraviti metodu isplata koja prima argument svotu koju je potrebno skinuti sa kartice. 
Ako kartica ima sredstava za ovu akciju smanjiti sredstava za svotu, dok ako ne postoji mogućnost za to samo ispisati stanje na kartici. 
Potrebno je pozivati metodu isplata sve dok je stanje na kartici veće od 0. Potrebno je koristiti distributer I slišače kao u primeru lekcije Upravljanje događajima."""
